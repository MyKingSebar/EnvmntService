...
public class EnvMntParamManager {
	...
	public void setSensorSpcInfo(SensorSpcInfo info) {
		if (info == null) {
			Logger.i("Sensor space info is null.");
			return;
		}
	...
	public void setAirConStatsInfo(AirConStatsInfo info) {
		if (info == null) {
			Logger.i("Air conditioner status info is null.");
			return;
		}
	...
	public void setDrtFanStatsInfo(DrtFanStatsInfo info) {
		if (info == null) {
			Logger.i("Draft fan status info is null.");
			return;
		}
	...
	public void setLcdDrvBoardInfo(LcdDrvBoardInfo info) {
		if (info == null) {
			Logger.i("Lcd driver board info is null.");
			return;
		}
	...
	public void setLgtRadSensorInfo(LgtRadSensorInfo info) {
		if (info == null) {
			Logger.i("Light radiation sensor info is null.");
			return;
		}
	...
	public void setPm25SensorInfo(Pm25SensorInfo info) {
		if (info == null) {
			Logger.i("PM2.5 sensor info is null.");
			return;
		}
	...
	public void setGpsRecvDataInfo(GpsRecvDataInfo info) {
		if (info == null) {
			Logger.i("Gps received data info is null.");
			return;
		}
